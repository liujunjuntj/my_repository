...
<html lang="en">
	...
	<div class="span12">
		<form id="app_add_form" class="form-horizontal">
			<div class="control-group">
				<label class="control-label"><i class="required">*</i>名称：</label>
				<div class="controls">
					<textarea name="appName" rows="1" class="span11" placeholder="app的名称" required></textarea>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label"><i class="required">*</i>描述：</label>
				<div class="controls">
					<textarea name="appDesc" rows="5" class="span11" placeholder="app的描述信息" required></textarea>
				</div>
			</div>			
