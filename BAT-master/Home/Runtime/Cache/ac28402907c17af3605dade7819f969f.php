...
<html lang="en">
	...
	<div class="span12">
		<form id="app_update_form" class="form-horizontal">
			<input type="hidden" name="id" value="<?php echo ($app["id"]); ?>" />
			<div class="control-group">
				<label class="control-label"><i class="required">*</i>名称：</label>
				<div class="controls">
					<textarea name="appName" rows="1" class="span11" placeholder="app的名称" required><?php echo ($app["appName"]); ?></textarea>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label"><i class="required">*</i>描述：</label>
				<div class="controls">
					<textarea name="appDesc" rows="5" class="span11" placeholder="app的描述信息" required><?php echo ($app["appDesc"]); ?></textarea>
				</div>
			</div>	
