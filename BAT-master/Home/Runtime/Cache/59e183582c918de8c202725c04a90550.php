...
<html lang="en">
    ...
    <div class="span12">
        <form id="module_add_form" class="form-horizontal">
                <div class="control-group">
                    <label class="control-label"><i class="required">*</i>名称：</label>
                    <div class="controls">
                        <textarea name="name" rows="1" class="span11" placeholder="模块名称" required></textarea>
                    </div>
                </div>
                <div class="control-group">
                <label class="control-label"><i class="required">*</i>描述：</label>
                <div class="controls">
                    <textarea name="desc" rows="5" class="span11" placeholder="模块的描述信息" required></textarea>
                </div>
                </div>
            <div class="span12">
                ...
                <div class="control-group span6">
                    ...
                    <div class="controls">
                        <select name="addedApps" id="addedApps" class="populate placeholder form-control span10" multiple>
